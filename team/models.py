...
class Event(models.Model):
    ...
    typeOfEvent = models.CharField(choices=(('match', 'match'), ('training', 'training')), max_length=8, default='training')
    ...
    teamA = models.ForeignKey(Team, on_delete=models.CASCADE, related_name='events')
    teamB = models.ForeignKey(Team, on_delete=models.CASCADE, null=True, blank=True)
    field = models.ForeignKey(Field, on_delete=models.CASCADE)
    referee = models.ManyToManyField(User, blank=True)
